   ...
   <div class="sidebar-nav">
    ...
    <p class="stat"><span class="number">15</span>waiting</p>
            ...
            <h1 class="page-title">后台</h1>
                ...
                <ul class="breadcrumb">
            <li><a href="<?= url('info/info')?>">Department</a> <span class="divider">/</span></li>
            <li class="active">DeUp</li>
        </ul>
 
<div class="breadcrumb">
    <center>
    <form action="<?= url('department/deUpDo')?>" method="post" enctype="multipart/form-data"> 
        <table>
