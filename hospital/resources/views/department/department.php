...
<div class="breadcrumb">
    <center>
        <table border="1px">
            ...
            <tr>
                <td width="150px" height="50px">科室名称：</td>
                <td width="800px">科室介绍：</td>
                <td width="100px">操&nbsp;&nbsp;作：</td>
            </tr>
             <?php foreach ($arr as $k => $v) { ?>

            <tr>

                <td><input type="hidden" value="<?php echo $v->sec_id?>">
                    <center><?php echo $v->sec_name?></center>
                </td>
                <td><?php echo $v->sec_content?></td>
                <td><center><a href="<?= url('department/deUp')?>?sec_id=<?= $v->sec_id?>">修改</a>||<a href="<?= url('department/deDel')?>?sec_id=<?= $v->sec_id?> ">删除</a></center></td>
            </tr>
