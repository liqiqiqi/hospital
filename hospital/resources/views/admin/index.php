...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="sidebar-nav">
        ...
        <a href="#accounts-menu" class="nav-header" data-toggle="collapse"><i class="icon-briefcase"></i>医院管理<i class="icon-chevron-up"></i></a>
        ...
        <a href="help.html" class="nav-header" ><i class="icon-question-sign"></i>预约管理<i class="icon-chevron-up"></i></a>
    </div>
