...
<div class="breadcrumb">
    <center>
      <form action="<?= url('doctor/doctorUpDo')?>" method="post" enctype="multipart/form-data">
      <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <table>
        <input type="hidden" name="doc_id" value="<?= $arr[0]->doc_id?>">
            <tr>
                <td>医生姓名：</td>
                <td><input type="text" name="doc_name" value="<?= $arr[0]->doc_name?>"></td>
            </tr>
            <tr>
                <td>医生头像：</td>
                <td><input type="file" name="doc_img"><img src="<?= $arr[0]->doc_img?>" alt="" width="150px" height="100px"></td>
            </tr>
            <tr>
                <td>医生电话：</td>
                <td><input type="tel" name="doc_tel" value="<?= $arr[0]->doc_tel?>"></td>
            </tr>
            <tr>
                <td>医生邮箱：</td>
                <td><input type="email" name="doc_email" value="<?= $arr[0]->doc_email?>"></td>
            </tr>
            <tr>
                <td>请选择科室：</td>
                <td>
            ...
            <tr>
                <td>最大限制人数：</td>
                <td><input type="text" name="max_peo" value="<?= $arr[0]->max_peo?>"></td>
            </tr>
            <tr>
                <td></td>
