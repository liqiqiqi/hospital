...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <p class="stat"><span class="number">15</span>waiting</p>
            ...
            <li class="active">InfoUp</li>
        </ul>
 
<div class="breadcrumb">
    <center>
    <form action="<?= url('info/infoUpdo')?>" method="post" enctype="multipart/form-data"> 
        <table>
            ...
            <tr>
                <td>医院logo：</td>
                <td><input type="file" name="hos_img"><img src="<?php echo $arr[0]->hos_img?>" alt="" width="100px" height="50px"></input></td>
            </tr>
            <tr>
                <td>紧急联系：</td>
